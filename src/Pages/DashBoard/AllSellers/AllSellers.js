...
const AllSellers = () => {
  ...
  const {
    ...
    queryFn: async ({queryKey}) => {
      ...
      const res = await fetch(`https://auto-reseller-api.vercel.app/users/sellers?page=${page}&limit=${sellersPerPage}&sort=${column}&order=${order}`, {
        headers: {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://auto-reseller-api.vercel.app/users/seller/${id}`, {
          method: "DELETE",
          headers: {
            "content-type": "application/json",
            authorization: `bearer ${localStorage.getItem("accessToken")}`,
  ...
  const handleVerify = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://auto-reseller-api.vercel.app/users/verify-seller/${id}`, {
          method: "PATCH",
